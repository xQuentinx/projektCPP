...
//p 1..p9 pola w grze (ich zawartosc: p1='n'; nic lub 'x' lub 'o')
char kto;
...
// funkcja ³adowania obrazów i rozpoczyna zawszwe gracz kolko
...
//---------------------------------------------------------------------------
// zmiana obrazka zalezenie od tego ktory gracz kliknal dla kazdego pola
...
//---------------------------------------------------------------------------
// strona WWW
void __fastcall TForm1::stronaWWW1Click(TObject *Sender)
{
 ShellExecute(NULL,"open","https://rekrutacja.ukw.edu.pl/oferta/studia-pierwszego-stopnia/informatyka)", NULL, NULL, SW_SHOWNORMAL);
}
//---------------------------------------------------------------------------
